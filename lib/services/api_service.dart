...
class ApiService {
  ...
  static String addCourse(Course course) {
    _courses.add(course);
    String jsonString = jsonEncode(_courses.map((course) => course.toJson()).toList());
    return jsonString;
  }
}
